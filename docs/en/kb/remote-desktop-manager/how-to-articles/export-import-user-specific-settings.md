...
![Data Source and {{ en.VLT }} Selection.png](https://webdevolutions.azureedge.net/docs/en/kb/KB2091.png)
...
![Data Source and {{ en.VLT }} Selection.png](https://webdevolutions.azureedge.net/docs/en/kb/KB4916.png)
1. Go to ***File – My Account Settings***.
1. Click ***User Specific Settings List***.  
