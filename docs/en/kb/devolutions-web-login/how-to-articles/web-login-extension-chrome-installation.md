...
eleventyComputed:
  ...
  description: Follow the steps to complete the installation of the {{ en.DWL }} in the Chrome web browser. 
  keywords:
  - Browser
  - Chrome
---
...
1. Open Chrome.
1. Navigate to the [{{ en.DWL }}](https://chrome.google.com/webstore/detail/devolutions-web-login/neimonjjffhehnojilepgfejkneaidmo?hl=en-US&gl=CA) or use the link from our [website](https://devolutions.net/web-login).
...
1. Click the Chrome extension button and pin the {{ en.DWL }} to finish the installation.  
