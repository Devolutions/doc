...
eleventyComputed:
  ...
  description: Follow the steps to complete the installation of the {{ en.DWL }} in the Opera web browser. 
  keywords:
  - Browser
  - Opera
---
Follow the steps below to complete the installation of the {{ en.DWL }} in the Opera web browser.

1. Open Opera.
1. Download the extension of the [{{ en.DWL }}](https://devolutions.net/web-login) from our website page.
...
1. Click on the ***Extensions*** button of the browser and ***Pin*** the {{ en.DWL }}.  
