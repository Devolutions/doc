...
eleventyComputed:
  ...
  - matching
---
Each URL in a ***Website*** entry has a comparing type associated to it. The comparing type determines if the {{ en.DWL }} should offer the entry as an available entry to perform autofill.
