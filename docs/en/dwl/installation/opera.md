...
![Install the {{ en.DWL }}](https://webdevolutions.azureedge.net/docs/en/dwl/Dwl4008.png)
1. Click on the Opera ***Extensions*** button and ***Pin*** the {{ en.DWL }} to finish the installation.  
![Pin the {{ en.DWL }}](https://webdevolutions.azureedge.net/docs/en/dwl/Dwl4005.png)  
