...
eleventyComputed:
  title: Edge
---
Follow the steps below to complete the installation of the {{ en.DWL }} in the Microsoft Edge web browser.  
...
![Add te {{ en.DWL }} to Microsoft Edge](https://webdevolutions.azureedge.net/docs/en/dwl/Dwl4013.png)  
