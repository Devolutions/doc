...
This topic assumes that you have previously [installed the {{ en.DWL }}](/rdm/mac/dwl/installation/) in your browser and that it is [connected to {{ en.RDMMAC }}](/rdm/mac/dwl/first-login-devolutions-web-login/). 
{% endsnippet %}
 
The {{ en.DWL }} is the tool of choice for users to interact in a password management context with {{ en.RDMMAC }}. It allows for:  
