...
This name can be used to identify a particular association and to deny access to it from {{ en.RDM }}. The default name is the name of the web browser running the {{ en.DWL }}. 
{% endsnippet %}
...
1. If you click on the {{ en.DWL }} icon in your web browser, you can validate that the {{ en.DWL }} is now paired to your {{ en.RDM }}.  
![Successful Association of {{ en.RDM }} to the {{ en.DWL }}](https://webdevolutions.azureedge.net/docs/en/rdm/mac/Dwl4059.png) 
