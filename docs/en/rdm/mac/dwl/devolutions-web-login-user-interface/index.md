...
The main view, which is the one displayed when first opening the {{ en.DWL }}, can be divided into three main sections:  
...
Each tab will display a different view in the ***Content Area***. The tabs available when using the {{ en.DWL }} with {{ en.RDMMAC }} are:  
...
* the ***About*** tab, where you will find links to useful tools and information about the {{ en.DWL }}.  
