...
The application access section allows to restrain access to {{ en.RDM }} or the [{{ en.DWL }}](/rdm/windows/dwl/overview/).  
...
[{{ en.DWL }}](/rdm/windows/dwl/overview/) 
		...
		<td>
Select if the user can access the data source from the {{ en.DWL }}. 
		</td>
	</tr>
</table>
