...
---
The Advanced Search allows you to search for entries and folders based on multiple criteria in one vault at a time. To search multiple {{ en.VLT }}s simultaneously, please refer to [***Multi Vault Search***](/rdm/windows/commands/view/panels/search/multi-vault/).  
