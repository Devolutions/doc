...
1. Cliquer ***Finsh*** pour compléter l'installation.
...
Il est également possible de voir Devolutions Hub Services en tant que service dans la fenêtre ***Services*** de Windows. Vous pouvez voir également afficher l'état actuel et démarrer ou arrêter le service.
