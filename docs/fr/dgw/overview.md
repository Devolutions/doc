...
* {{ fr.DGW }} peut être utilisé avec les types d'entrées de connexion supportés (RDP, SSH, VNC, ARD, PowerShell, sites Web) dans {{ fr.RDM }} et les sources de données supportées ( {{ fr.DPS }} , {{ fr.PHUB }} ).  
