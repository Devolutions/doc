...
* {{ labels.DHUBP.en }}: Import and export your {{ en.DHUBP }} data source entries [with {{ en.RDM }}](/rdm/kb/rdm-windows/how-to-articles/export-import-entries/) or in Json format directly [from {{ en.DHUBP }}](/hub/web-interface/tools/import-export/) in ***Tools – Export***.
